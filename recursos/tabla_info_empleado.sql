CREATE OR REPLACE FUNCTION tabla_info_empleado(id_des integer, search_ text, order_ integer, start_ integer, length_ integer,id_ciudad text,tipo_empleado text)
  RETURNS text AS
$BODY$
declare 
	l json;
...
$BODY$ 
  ...
  COST 100;
ALTER FUNCTION tabla_info_empleado(integer,text,integer,integer,integer,text,text)
  OWNER TO postgres;
