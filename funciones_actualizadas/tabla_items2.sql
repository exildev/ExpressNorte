-- Function: tabla_items(integer, text, integer, integer, integer)

-- DROP FUNCTION tabla_items(integer, text, integer, integer, integer);

CREATE OR REPLACE FUNCTION tabla_items(id_des integer, search_ text, order_ integer, start_ integer, length_ integer)
  RETURNS text AS
$BODY$
declare 
	l json;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION tabla_items(integer, text, integer, integer, integer)
  OWNER TO postgres;
